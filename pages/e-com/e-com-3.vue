...
<section class="p-5">
   <div class="columns is-desktop">
      <div class="column">
         <div class="card is-shadowless" style="border: 2px solid #E5E7EB;">
            <div class="card-image">
               <figure class="image is-2by1">
                  <img src="https://dummyimage.com/640x320/f5f5f5/777778" alt="Placeholder image">
               </figure>
            </div>
            <div class="card-content">
               <div>
                  <h1 class="title is-4 mb-3 is-size-5-mobile">The Catalyzer</h1>
                  <p class="pt-0 mt-0 is-pulled-right" style="text-decoration: line-through;">$ 65.00</p>
                  <p class="has-text-primary pb-5">
               ...
               <div class="columns is-mobile">
                  ...
                  <div class="column px-3">
                     <button class="button is-primary  is-pulled-right ">Button</button>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="column">
         <div class="card is-shadowless" style="border: 2px solid #E5E7EB;">
            ...
            <div class="card-content">
               <div>
                  <h1 class="title is-4 mb-3 is-size-5-mobile">The 400 Blows</h1>
                  <p class="pt-0 mt-0 is-pulled-right" style="text-decoration: line-through;">$ 65.00</p>
                  <p class="has-text-primary pb-5">
                     <span class="icon-text">
                     <span class="icon pl-6">
      ...
      <div class="column">
         <div class="card is-shadowless" style="border: 2px solid #E5E7EB;">
            ...
            <div class="card-content">
               <div>
                  <h1 class="title is-4 mb-3 is-size-5-mobile">Neptune</h1>
                  <p class="pt-0 mt-0 is-pulled-right" style="text-decoration: line-through;">$ 65.00</p>
                  <p class="has-text-primary pb-5">
                     <span class="icon-text">
                     <span class="icon pl-6">
      ...
      <div class="column">
         <div class="card is-shadowless" style="border: 2px solid #E5E7EB;">
            ...
            <div class="card-content">
               <div>
                  <h1 class="title is-4 mb-3 is-size-5-mobile">Shooting Stars</h1>
                  <p class="pt-0 mt-0 is-pulled-right" style="text-decoration: line-through;">$ 65.00</p>
                  <p class="has-text-primary pb-5">
                     <span class="icon-text">
                     <span class="icon pl-6">
