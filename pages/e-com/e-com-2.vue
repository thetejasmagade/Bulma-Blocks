      ...
      <div class="container is-max-widescreen">
        <div class="columns">
          ...
          <div class="column">
            ...
            <div class="mt-3">
              <span
                class="icon is-small is-pulled-right has-text-grey mr-6 mt-2"
              >
                <i class="far fa-eye"></i>&nbsp;1.5K
                <span class="px-2">|</span>
                <i class="far fa-comment"></i>&nbsp;5
              </span>
              <p :class="classOfTextColor">
                <span class="icon-text">
                  <span class="icon pl-6">
            ...
            <div class="columns is-mobile">
              <div class="column">
                <span class="has-text-weight-medium">Color:&nbsp;</span>
                <span class="icon is-clickable">
                  <i class="fas fa-lg fa-circle has-text-grey-lighter"></i>
                </span>
                <span class="icon is-clickable">
                  <i class="fas fa-lg fa-circle"></i>
                </span>
                <span class="icon is-clickable">
                  <i class="fas fa-lg fa-circle" :class="classOfTextColor"></i>
                </span>
              </div>
              <div class="column">
   ...
   <div class="container is-max-widescreen">
      <div class="columns">
         ...
         <div class="column">
            ...
            <h1 class="title is-3 is-size-4-mobile mb-0">The Catcher in the Rye</h1>
            <div class="mt-3">
               <span class="icon is-small is-pulled-right has-text-grey mr-6 mt-2">
               <i class="far fa-eye"></i>&nbsp;1.5K
               <span class="px-2">|</span>
               <i class="far fa-comment"></i>&nbsp;5
               </span>
            ...
            <p class="py-5">
               ...
               microdosing tilde DIY. XOXO fam
               indxgo juiceramps cornhole raw denim forage brooklyn. Everyday carry +1 seitan poutine
               tumeric. Gastropub blue bottle
            ...
            <div class="columns is-mobile">
               <div class="column">
                  ...
                  <span class="icon is-clickable">
                  <i class="fas fa-lg fa-circle has-text-primary"></i>
                  </span>
               </div>
               <div class="column">
                  <span class="has-text-weight-medium">Size:&nbsp;</span>
