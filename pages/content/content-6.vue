...
<section class="p-5">
   <div class="columns is-desktop mb-4">
      <div class="column">
         <h1 class="title is-3 pb-2 mb-0 is-size-4-mobile">Space The Final Frontier</h1>
         <div style="height: 0.25rem; width: 5rem; background-color: #00d1b2; border-radius: 0.25rem;">
         </div>
      </div>
      <div class="column">
         <p class="pb-4 mr-4">
            Street art subway tile salvia four dollar toast bitters selfies quinoa yuccie synth meditation
            iPhone intelligentsia
   ...
   <div class="columns is-desktop">
      <div class="column">
         <figure class="image is-16x9 mb-5">
            <img src="https://dummyimage.com/1200x500/f5f5f5/777778">
         </figure>
         <h1 class="title is-4 pb-3 my-2 is-size-5-mobile">Shooting Stars</h1>
         <p class="pb-3 mr-4">
      ...
      <div class="column">
         ...
         <h1 class="title is-4 pb-3 my-2 is-size-5-mobile">The Catalyzer</h1>
         <p class="pb-3 mr-4">
            Swag shoivdigoitch literally meditation subway tile tumblr cold-pressed. Gastropub street art beard
            dreamcatcher neutra,
            ethical XOXO lumbersexual.
      ...
      <div class="column">
         ...
         <h1 class="title is-4 pb-3 my-2 is-size-5-mobile">The 400 Blows</h1>
         <p class="pb-3 mr-4">
            Swag shoivdigoitch literally meditation subway tile tumblr cold-pressed. Gastropub street art beard
            dreamcatcher neutra,
            ethical XOXO lumbersexual.
