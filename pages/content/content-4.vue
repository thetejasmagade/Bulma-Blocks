...
<section class="p-5">
   <div class="columns is-desktop">
      <div class="column">
         <h1 class="title is-3 is-size-4-mobile">Kickstarter Actually Pinterest Brunch Bitters Occupy</h1>
      </div>
      <div class="column">
         <p class="pb-5">
            Taxidermy bushwick celiac master cleanse microdosing seitan. Fashion axe four dollar toast truffaut,
            direct trade
            kombucha brunch williamsburg keffiyeh gastropub tousled squid meh taiyaki drinking vinegar tacos.
         </p>
         <span>
         <button class="button is-primary pr-4 px-5">Button</button>
         <span class="icon-text pl-4 pt-2">
            <span><a href="#" class="has-text-primary is-size-6">Learn More</span>
            <span class="icon">
