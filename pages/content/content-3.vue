...
export default {
  data() {
    return {
      ...
      code: `
<section class="p-5">
   <div class="container is-centered has-text-centered mb-6">
      <h1 class="title is-3 is-size-4-mobile">Pitchfork Kickstarter Taxidermy</h1>
      <p class="subtitle is-6 has-text-grey py-4">Whatever cardigan tote bag tumblr hexagon brooklyn
         asymmetrical
   ...
   <div class="columns is-desktop">
      <div class="column">
         <div class="card is-shadowless" style="border: 1px solid #E5E7EB;">
            <div class="card-content">
               <div class="mb-4">
                  <span class="icon is-large">
                  <span class="fa-stack fa-lg">
                  <i class="fas fa-circle fa-stack-2x has-text-primary-light"></i>
                  <i class="fas fa-chart-line fa-stack-1x fa-inverse has-text-primary"></i>
                  </span>
                  </span>
               </div>
               <div>
                  <h1 class="title is-5 pb-4 is-size-5-mobile">Shooting Stars</h1>
               </div>
               <div class="content">
                  <p>
         ...
         <div class="card is-shadowless" style="border: 1px solid #E5E7EB;">
            <div class="card-content">
               <div class="mb-4">
                  ...
                  <span class="fa-stack fa-lg">
                  <i class="fas fa-circle fa-stack-2x has-text-primary-light"></i>
                  <i class="fas fa-cut fa-stack-1x fa-inverse has-text-primary"></i>
                  </span>
                  </span>
               </div>
               <div>
                  <h1 class="title is-5 pb-4 is-size-5-mobile">The Catalyzer</h1>
               </div>
               <div class="content">
                  <p>
                     Fingerstache flexitarian street art 8-bit waist co, subway tile poke farm.
         ...
         <div class="card is-shadowless" style="border: 1px solid #E5E7EB;">
            <div class="card-content">
               <div class="mb-4">
                  ...
                  <span class="fa-stack fa-lg">
                  <i class="fas fa-circle fa-stack-2x has-text-primary-light"></i>
                  <i class="fas fa-user fa-stack-1x fa-inverse has-text-primary"></i>
                  </span>
                  </span>
               </div>
               <div>
                  <h1 class="title is-5 pb-4 is-size-5-mobile">Neptune</h1>
               </div>
               <div class="content">
                  <p>
                     Fingerstache flexitarian street art 8-bit waist co, subway tile poke farm.
         ...
         <div class="card is-shadowless" style="border: 1px solid #E5E7EB;">
            <div class="card-content">
               <div class="mb-4">
                  ...
                  <span class="fa-stack fa-lg">
                  <i class="fas fa-circle fa-stack-2x has-text-primary-light"></i>
                  <i class="far fa-flag fa-stack-1x fa-inverse has-text-primary"></i>
                  </span>
                  </span>
               </div>
               <div>
                  <h1 class="title is-5 pb-4 is-size-5-mobile">Melanchole</h1>
               </div>
               <div class="content">
                  <p>
                     Fingerstache flexitarian street art 8-bit waist co, subway tile poke farm.
         ...
         <div class="card is-shadowless" style="border: 1px solid #E5E7EB;">
            <div class="card-content">
               <div class="mb-4">
                  ...
                  <span class="fa-stack fa-lg">
                  <i class="fas fa-circle fa-stack-2x has-text-primary-light"></i>
                  <i class="far fa-moon fa-stack-1x fa-inverse has-text-primary"></i>
                  </span>
                  </span>
               </div>
               <div>
                  <h1 class="title is-5 pb-4 is-size-5-mobile">Bunker</h1>
               </div>
               <div class="content">
                  <p>
                     Fingerstache flexitarian street art 8-bit waist co, subway tile poke farm.
         ...
         <div class="card is-shadowless" style="border: 1px solid #E5E7EB;">
            <div class="card-content">
               <div class="mb-4">
                  ...
                  <span class="fa-stack fa-lg">
                  <i class="fas fa-circle fa-stack-2x has-text-primary-light"></i>
                  <i class="fas fa-shield-alt fa-stack-1x fa-inverse has-text-primary"></i>
                  </span>
                  </span>
               </div>
               <div>
                  <h1 class="title is-5 pb-4 is-size-5-mobile">Ramona Falls</h1>
               </div>
               <div class="content">
                  <p>
                     Fingerstache flexitarian street art 8-bit waist co, subway tile poke farm.
   ...
   <div class="has-text-centered py-5">
      <button class="button is-primary is-size-5 is-size-6-mobile px-5">Button</button>
   </div>
</section>
    `,
    };
