...
<section class="p-5">
   <div class="columns is-desktop">
      <div class="column">
         <div class="box has-background-light has-text-centered is-shadowless">
            <div>
               <h2 class="subtitle is-6 is-uppercase pb-2 has-text-grey">CATEGORY</h2>
               <h1 class="title is-4 pb-5 is-size-5-mobile">Blog Title Here</h1>
            </div>
            <div class="content">
            ...
            <span class="icon is-small has-text-grey-light m-5">
