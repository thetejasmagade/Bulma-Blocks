      ...
      <div class="column">
         <div class="card is-shadowless" style="border: 2px solid #E5E7EB;">
            ...
            <div class="card-content">
               <div>
                  <h2 class="subtitle is-6 is-uppercase pb-2 has-text-grey">CATEGORY</h2>
                  <h1 class="title is-4 pb-5 is-size-5-mobile">The Catalyzer</h1>
               </div>
               <div class="content">
               ...
               <div>
                  ...
                  <span class="icon is-small is-pulled-right has-text-grey-light mr-6">
      ...
      <div class="column">
         <div class="card is-shadowless" style="border: 2px solid #E5E7EB;">
            ...
            <div class="card-content">
               <div>
                  <h2 class="subtitle is-6 is-uppercase pb-2 has-text-grey">CATEGORY</h2>
                  <h1 class="title is-4 pb-5 is-size-5-mobile">The 400 Blows</h1>
               </div>
               <div class="content">
                  Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled
                  waistcoat.
      ...
      <div class="column">
         <div class="card is-shadowless" style="border: 2px solid #E5E7EB;">
            ...
            <div class="card-content">
               <div>
                  <h2 class="subtitle is-6 is-uppercase pb-2 has-text-grey">CATEGORY</h2>
                  <h1 class="title is-4 pb-5 is-size-5-mobile">Shooting Stars</h1>
               </div>
               <div class="content">
                  Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled
                  waistcoat.
