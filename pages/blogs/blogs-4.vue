...
<section class="p-5">
   <div class="columns is-gapless is-multiline">
      <div class="column is-one-quarter">
         <p class="has-text-primary py-2"><span
            class="has-background-info-light p-1 box-radius has-text-weight-medium is-size-7-mobile">CATEGORY</span>
         </p>
         <p class="mb-4">12 Mar 2021</p>
      </div>
      <div class="column">
         <h1 class="title is-4 is-size-5-mobile">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod
            tempor
         </h1>
         <p class="pb-5">
