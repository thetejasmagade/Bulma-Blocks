...
<section class="p-5">
   ...
   <div class="column">
      <p class="has-text-primary py-3"><span
         class="has-background-info-light p-1 box-radius has-text-weight-medium is-size-7-mobile">ROOF
         PARTY POLAROID</span>
      </p>
      <h1 class="title is-3 pb-5 my-1 is-size-5-mobile">Master Cleanse Reliac Heirloom</h1>
   </div>
   <div class="column">
