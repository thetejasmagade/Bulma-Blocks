...
<section class="p-5">
   <div class="container is-centered has-text-centered is-max-widescreen">
      ...
      <p class="subtitle is-6 has-text-grey py-4">Whatever cardigan tote bag tumblr hexagon brooklyn
         ...
         probably haven't heard of them man bun deep.
      </p>
      <div class="pt-3">
         <div class="columns pb-3">
            <div class="column">
               <label class="label is-pulled-left">Full Name</label>
               <input class="input" type="text" placeholder="e.g. Alex Demo">
            </div>
            <div class="column">
               <label class="label is-pulled-left">Email</label>
               <input class="input" type="email" placeholder="e.g. alex@demo.com">
            </div>
         </div>
         <button class="button is-primary is-medium px-5">Button</button>
      </div>
   </div>
</section>
`,
