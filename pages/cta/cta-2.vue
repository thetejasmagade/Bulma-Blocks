...
<section class="p-5">
   <div class="columns is-desktop">
      <div class="column is-three-fifths is-8 mt-6 pt-5">
         <h1 class="title is-3 is-size-4-mobile">Slow-carb next level shoindcgoitch ethical authentic, poko
            scenester
         </h1>
         <p class="is-size-6">
            Poke slow-carb mixtape knausgaard, typewriter street art gentrify hammock starladder roathse. Craies
            vegan tousled etsy
            austin.
         </p>
      </div>
      <div class="column">
         <form class="box has-background-light is-shadowless">
            <div class="field">
               <label class="label">Name</label>
               <div class="control">
                  <input class="input" type="email" placeholder="e.g. Alex Demo">
               </div>
            </div>
            ...
            <p class="is-size-7 mt-2">Literally you probably haven't heard of them jean shorts.</p>
         </form>
      </div>
   </div>
</section>
