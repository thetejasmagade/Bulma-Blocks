...
export default {
  data() {
    return {
      ...
      classOfStyle: "#00d1b2",
      classOfBorderColor: "border: 2px solid #00d1b2;",
      isPreviewLayout: true,
      code: `
<section class="p-5">
        <div class="container is-max-widescreen pb-5 mb-5">
            <h1 class="title is-3 is-size-4-mobile has-text-centered mb-2">Master Cleanse Reliac Heirloom</h1>
            <p class="has-text-centered pb-4">Whatever cardigan tote bag tumblr hexagon brooklyn asymmetrical gentrify,
                subway tile poke farm-to-table. Franzen you
                probably haven't heard of them man bun deep jianbing selfies heirloom prism food truck ugh squid celiac
                humblebrag.</p>
        </div>
        <div class="columns is-desktop is-centered has-text-centered">
            <div class="column">
                <div class="card is-shadowless p-5" style="border: 2px solid #E5E7EB;">
                    <span class="icon pt-5">
                        <i class="fab fa-mixcloud fa-3x has-text-primary"></i>
                    </span>
                    <div class="pt-3">
                        <h1 class="title is-3 is-size-4-mobile py-0 my-0">2.7K
                        </h1>
                        <p class="py-0 my-0">Users</p>
                    </div>
                </div>
            </div>
            <div class="column">
                <div class="card is-shadowless p-5" style="border: 2px solid #E5E7EB;">
                    ...
                    <div class="pt-3">
                        <h1 class="title is-3 is-size-4-mobile py-0 my-0">1.3K
                        </h1>
                        <p class="py-0 my-0">Subscribers</p>
                    </div>
                </div>
            </div>
            <div class="column">
                <div class="card is-shadowless p-5" style="border: 2px solid #E5E7EB;">
                    <span class="icon pt-5">
                        <i class="fas fa-headphones-alt fa-3x has-text-primary"></i>
                    </span>
                    <div class="pt-3">
                        <h1 class="title is-3 is-size-4-mobile py-0 my-0">75
                        </h1>
                        <p class="py-0 my-0">Files</p>
                    </div>
                </div>
            </div>
            <div class="column">
                <div class="card is-shadowless p-5" style="border: 2px solid #E5E7EB;">
                    ...
                    <div class="pt-3">
                        <h1 class="title is-3 is-size-4-mobile py-0 my-0">46
                        </h1>
                        <p class="py-0 my-0">Places</p>
                    </div>
                </div>
            </div>
        </div>
...
`,
  ...
  methods: {
    ...
    replaceBorderColor(msg) {
      for (var i = 0; i <= 13; i++) {
        this.code = this.code.replace("border: 2px solid #00d1b2;", msg);
        this.code = this.code.replace("border: 2px solid #209cee;", msg);
        this.code = this.code.replace("border: 2px solid #3273dc;", msg);
        this.code = this.code.replace("border: 2px solid #23d160;", msg);
        this.code = this.code.replace("border: 2px solid #ffdd57;", msg);
        this.code = this.code.replace("border: 2px solid #ff3860;", msg);
      }
    },
    updateColor(color) {
      ...
      if (this.appBarColor == "#00d1b2") {
        ...
        this.classOfBorderColor = "border: 2px solid #00d1b2;";
        ...
        this.replaceBorderColor("border: 2px solid #00d1b2;");
        ...
        this.classOfBorderColor = "border: 2px solid #209cee;";
        ...
        this.replaceBorderColor("border: 2px solid #209cee;");
        ...
        this.classOfBorderColor = "border: 2px solid #3273dc;";
        ...
        this.replaceBorderColor("border: 2px solid #3273dc;");
        ...
        this.classOfBorderColor = "border: 2px solid #23d160;";
        ...
        this.replaceBorderColor("border: 2px solid #23d160;");
        ...
        this.classOfBorderColor = "border: 2px solid #ffdd57;";
        ...
        this.replaceBorderColor("border: 2px solid #ffdd57;");
        ...
        this.classOfBorderColor = "border: 2px solid #ff3860;";
        ...
        this.replaceBorderColor("border: 2px solid #ff3860;");
      }
    },
  },
};
