...
<section class="p-5">
        <div class="columns is-variable is-6">
            <div class="column">
                <h4 class="title is-4 pt-5">Moon hashtag pop-up try-hard offal truffaut</h4>
                <p class="mt-0">Pour-over craft beer pug drinking vinegar live-edge gastropub, keytar neutra sustainable
                    fingerstache
                    kickstarter.</p>
                <div class="columns pt-5 mt-5 is-mobile is-variable is-1">
                    <div class="column">
                    ...
                    <div class="column">
                        <h1 class="title is-3 is-size-4-mobile py-0 my-0">1.8K
                        </h1>
                        <p class="py-0 my-0">Subscribers</p>
                    </div>
                    <div class="column">
                        <h1 class="title is-3 is-size-4-mobile py-0 my-0"> 35 </h1>
                        <p class="py-0 my-0">Downloads</p>
                    </div>
                    <div class="column">
                        <h1 class="title is-3 is-size-4-mobile py-0 my-0">7
                        </h1>
                        <p class="py-0 my-0">Products</p>
                    </div>
                </div>
            </div>
            <div class="column">
                <figure class="image is-2by1">
                    <img src="https://dummyimage.com/640x320/f5f5f5/777778">
                </figure>
            </div>
        </div>
</section>
