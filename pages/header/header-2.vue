<template>
  <div>
    ...
    />
    <div class="m-5"></div>
    <PreviewLayout v-if="isPreviewLayout" :code="code" class="py-6" />
    <CodeLayout v-else :code="code" :requiredJs="requiredJs" />
...
<nav class="navbar is-transparent">
        <div class="navbar-brand">
            <a class="navbar-item" href="#">
                <span class="icon-text">
                    ...
                    <span>
                        <h3 class="title is-5 pl-1 pt-3">BULMA BLOCKS</h3>
                    </span>
                </span>
            </a>
            <div class="navbar-burger" data-target="navbarExampleTransparentExample1">
                <span></span>
                <span></span>
                <span></span>
            </div>
        ...
        <div id="navbarExampleTransparentExample1" class="navbar-menu">
