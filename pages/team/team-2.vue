...
export default {
  data() {
    return {
      ...
      code: `
<section class="p-5">
        <div class="container is-max-widescreen centered has-text-centered">
            <h2 class="title is-4 pb-2 my-1 is-size-5-mobile">OUR TEAM</h2>
            <p>Whatever cardigan tote bag tumblr hexagon brooklyn asymmetrical gentrify, subway tile poke farm-to-table.
                Franzen you
                probably haven't
                <br />
                heard of them.
        ...
        <div class="columns is-desktop pt-5 mt-5">
            <div class="column">
                <div class="columns is-mobile">
                    <div class="column is-one-quarter">
                        <figure class="image is-256x256">
                            <img src="https://dummyimage.com/200x200/f5f5f5/777778" alt="Image">
                        </figure>
                    </div>
                    <div class="column">
                        <h4 class="is-size-5 has-text-weight-medium">Holden Caulfield</h4>
                        <p class="has-text-grey">UI Designer</p>
                        <p class="has-text-grey-darker pt-4">DIY tote bag drinking vinegar cronut adaptogen squid fanny
                            pack
                            vaporware.</p>
                        <span class="icon is-smallhas-text-grey-light ml-5 pt-4">
                            <i class="fab fa-facebook-f px-2"></i>&nbsp;
                            <i class="fab fa-twitter"></i>&nbsp;
                            <i class="far fa-comment px-2"></i>&nbsp;
                        </span>
                    </div>
                </div>
                <div class="columns is-mobile pt-3">
                    ...
                    <div class="column">
                        <h4 class="is-size-5 has-text-weight-medium">Henry Letham</h4>
                        <p class="has-text-grey">UI Designer</p>
                        <p class="has-text-grey-darker pt-4">DIY tote bag drinking vinegar cronut adaptogen squid fanny
                            pack
                            vaporware.</p>
            ...
            <div class="column">
                <div class="columns is-mobile">
                    ...
                    <div class="column">
                        <h4 class="is-size-5 has-text-weight-medium">Alper Kamu</h4>
                        <p class="has-text-grey">Designer</p>
                        <p class="has-text-grey-darker pt-4">DIY tote bag drinking vinegar cronut adaptogen squid fanny
                            pack
                            vaporware.</p>
                        <span class="icon is-smallhas-text-grey-light ml-5 pt-4">
                ...
                <div class="columns is-mobile pt-3">
                    ...
                    <div class="column">
                        <h4 class="is-size-5 has-text-weight-medium">Atticus Finch</h4>
                        <p class="has-text-grey">Designer</p>
                        <p class="has-text-grey-darker pt-4">DIY tote bag drinking vinegar cronut adaptogen squid fanny
                            pack
                            vaporware.</p>
