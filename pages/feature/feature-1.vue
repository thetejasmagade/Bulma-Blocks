...
<section class="p-5">
   <div class="container is-max-widescreen pb-5 mb-5">
      <h1 class="title is-3 is-size-4-mobile has-text-centered">Raw Denim Heirloom Man Braid
         <br class="is-hidden-mobile" />Selfies Wayfarers.
      </h1>
   </div>
   <div class="columns is-desktop pt-5">
      <div class="column">
         <div class="columns is-mobile">
            ...
            <div class="column ml-6">
               <h1 class="title is-5 is-size-5-mobile">Shooting Stars</h1>
               <p class="pb-3 mr-4">
      ...
      <div class="column">
         <div class="columns is-mobile">
            ...
            <div class="column ml-6">
               <h1 class="title is-5 is-size-5-mobile">The Catalyzer</h1>
               <p class="pb-3 mr-4">
                  Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy. Gastropub indxgo
                  juice poutine, ramps
                  microdosing banh mi pug VHS try-hard ugh iceland kickstarter tumblr live-edge tilde.
      ...
      <div class="column">
         <div class="columns is-mobile">
            ...
            <div class="column ml-6">
               <h1 class="title is-5 is-size-5-mobile">Neptune</h1>
               <p class="pb-3 mr-4">
                  Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy. Gastropub indxgo
                  juice poutine, ramps
                  microdosing banh mi pug VHS try-hard ugh iceland kickstarter tumblr live-edge tilde.
