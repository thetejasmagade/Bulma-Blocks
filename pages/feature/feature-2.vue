...
<section class="p-5">
        <div class="container is-max-widescreen pb-5 mb-5">
            <h1 class="title is-3 is-size-4-mobile has-text-centered mb-2">Raw Denim Heirloom Man Braid</h1>
            <p class="has-text-centered pb-4">Blue bottle crucifix vinyl post-ironic four dollar toast vegan
                taxidermy.
                Gastropub indxgo juice poutine,
                ramps
                microdosing banh mi pug.</p>
            <div style="height: 0.25rem; width: 5rem; background-color: #00d1b2; border-radius: 0.25rem;"
                class="m-auto p-auto">
            </div>
        </div>
        <div class="columns is-desktop is-centered has-text-centered">
            <div class="column">
                ...
                <h1 class="title is-5 pt-4 is-size-5-mobile">Shooting Stars</h1>
                <p class="mb-3">Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy. Gastropub
                    indxgo juice
                    poutine, ramps
                    microdosing banh mi pug VHS try-hard.</p>
        ...
        <div class="has-text-centered pt-5">
            <button class="button is-primary is-centered has-text-centered px-5">Button</button>
        </div>
</section>
`,
    };
